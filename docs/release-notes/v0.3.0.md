...
## 📦 Example: Complete Metadata Output
...
<testsuite>
  <properties>
    ...
    <property name="git:branch" value="main"/>
    <property name="git:status" value="clean"/>
    <property name="git:remote" value="https://github.com/jrjsmrtn/pytest-jux.git"/>

    <!-- CI metadata (auto-detected) -->
    <property name="ci:provider" value="github"/>
    <property name="ci:build_id" value="123456"/>
    <property name="ci:build_url" value="https://github.com/jrjsmrtn/pytest-jux/actions/runs/123456"/>
...
For questions or issues, please [open an issue](https://github.com/jrjsmrtn/pytest-jux/issues).
