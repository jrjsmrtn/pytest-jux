...
class TestEdgeCases:
    ...
    def test_main_handles_unexpected_error_in_debug_mode(self, tmp_path: Path) -> None:
    ...
    def test_main_handles_unexpected_error_without_debug(self, tmp_path: Path) -> None:
        ...
        with (
            ...
            patch.dict("os.environ", {"JUX_DEBUG": "0"}, clear=True),
        ):
            exit_code = main()
